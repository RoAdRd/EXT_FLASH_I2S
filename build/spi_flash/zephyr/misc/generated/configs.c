...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_I2S_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_I2S, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_I2S0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_SECTION_CUSTOM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_SECTION_CUSTOM_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_RTT_INIT_MODE_STRONG_CHECK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_I2S0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2S_NRFX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2S_NRFX_RX_BLOCK_COUNT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2S_NRFX_TX_BLOCK_COUNT, 4);
