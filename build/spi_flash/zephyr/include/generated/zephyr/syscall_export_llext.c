...
extern __weak ALIAS_OF(no_handler) void * const z_impl_nrf_qspi_nor_xip_enable;
...
extern __weak ALIAS_OF(no_handler) void * const z_impl_i2s_configure;
extern __weak ALIAS_OF(no_handler) void * const z_impl_i2s_buf_read;
extern __weak ALIAS_OF(no_handler) void * const z_impl_i2s_buf_write;
extern __weak ALIAS_OF(no_handler) void * const z_impl_i2s_trigger;
extern __weak ALIAS_OF(no_handler) void * const z_impl_mbox_send;
extern __weak ALIAS_OF(no_handler) void * const z_impl_mbox_mtu_get;
extern __weak ALIAS_OF(no_handler) void * const z_impl_mbox_set_enabled;
extern __weak ALIAS_OF(no_handler) void * const z_impl_mbox_max_channels_get;
